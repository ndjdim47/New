...
module.exports = {
  ...
  onStart: async function ({ api, event, args, usersData, threadsData }) {
    ...
    var background = [
      ...
      "https://i.postimg.cc/wxkfpJsM/background1.png",
      "https://i.postimg.cc/vZCXztCq/background2.png",
      "https://i.postimg.cc/FRVZh5z8/background3.png",
      "https://i.postimg.cc/fyWvL20L/background4.png",
      "https://i.postimg.cc/zvdFRCnk/background5.png", 
    ];
