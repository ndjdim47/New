...
module.exports = {
  ...
  onStart: async function ({ api, event, args, usersData, threadsData }) {
    ...
    var background = [
      ...
      "https://i.postimg.cc/y6nP5HwS/background1.png",
      "https://i.postimg.cc/rpSG9X1s/background2.png",
      "https://i.postimg.cc/B6pxdTwG/background3.png",
      "https://i.postimg.cc/zvfn5y9H/background4.png",
      "https://i.postimg.cc/jdmz0dvC/background5.png", 
