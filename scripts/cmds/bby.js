...
module.exports.onChat = async ({ api, event,message }) => {
  try{
    ...
    if(body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("janu") || body.startsWith("kuttu")){
      const arr = body.replace(/^\S+\s*/, "") || "ayanokoji ";
      if (arr === "ayanokoji "){ 
const funnyReplies = [
    ...
    "Amake vhule jao 🥺",
    "Ami shudhu ayanokoji er. Don't disturb me! 🤦",
    ...
    "আমার বস ayanokoji রে ডাক ওই সিঙ্গেল আছে 🐸🫦",
